  ...
  return (
    <div className="bg-card rounded-xl border border-border p-8">
      ...
      <p className="text-muted-foreground text-center text-sm mb-6">
        Start building messaging frameworks
      </p>
      ...
      <div>
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-border text-sm font-medium hover:bg-muted/50 transition-colors"
        >
